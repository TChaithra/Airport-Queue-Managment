...
OV_MODEL_CANDIDATES = [
    ...
    _SCRIPT_DIR / "latest_int8_openvino_model"     / "latest.xml",
    # _SCRIPT_DIR / "Top_view_persons_detection_int8_openvino_model"/ "Top_view_persons_detection.xml",   # ← your trained model FIRST
   # _SCRIPT_DIR / "best_int8_openvino_model"     / "best.xml", 
]

CONF_THR = 0.18
IOU_THR  = 0.30
INF_SIZE = 640
MIN_BOX_PX = 15   # reject bboxes with width OR height < 15 px (stanchions/cans)
...
class QueueAnalytics:
    def __init__(self, alert_thr=10, wait_thr=90.0, cam_id=1):
